...
Запускать под средой - python3 gen_eda_report.py или ./eda_script_launcher.sh +1
...
python3 ft_perceptron.py или ./train.sh +3
...
python3 ft_perceptron.py --predict или ./test.sh +3
...
Json файл с весами и pkl модедью загружается в папку data в файл model.json. +3 
